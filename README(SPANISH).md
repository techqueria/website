...
[Techqueria](http://techqueria.org/) es una organización sin fines de lucro que sirve a la comunidad más grande de Latinx en tecnología. 🌮

Este repo es donde alojamos nuestro sitio web de código abierto y pronto será el hub de miembros.

## Contribuyendo

> Para empezar...

1. 🍴 [Fork](https://github.com/techqueria/website#fork-destination-box) este repositorio
2. 🔨 Vea nuestras [directrices para contribuir](.github/CONTRIBUTING.md)
3. 🎉 [Abrir una nueva solicitud de pull](https://github.com/techqueria/website/compare) y lo aprobado!

Puede incluso [informar de un fallo o solicitar una función](https://github.com/techqueria/website/issues/new/choose) ¡cualquier pedacito de ayuda cuenta! 😊
...
Más organismo pueden ser encontrados en este proyecto [código de conducta](.github/CODE_OF_CONDUCT.md).

## 💛️ Cantabria Colaboradores, Patrocinadores Y Patrocinadores

### Este proyecto existe gracias a todas las * * personas que contribuyen**.([Convertirse en un contribuyente](.github/CONTRIBUTING.md))
...
### ¡Gracias a todos nuestros patrocinadores! ([Conviértete en un patrocinador](https://opencollective.com/techqueria#backer))
...
### **Apoyar este proyecto al convertirse en un patrocinador.** Su logotipo aparecerá aquí con un enlace a su sitio web. ([Convertirse en un patrocinador](https://opencollective.com/techqueria#sponsor))
